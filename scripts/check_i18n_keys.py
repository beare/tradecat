...
扫描 `plugins/telegram/src` 下的 Python 代码，抽取 `_t/_btn/_btn_lang/I18N.gettext`
中的字符串字面量作为消息键，与 `plugins/telegram/locales/*/LC_MESSAGES/bot.po`
中的 msgid 做集合对比：
- 缺失键：代码使用但 po 中不存在
...
SRC_ROOT = REPO_ROOT / "plugins" / "telegram" / "src"


def _discover_locale_dir() -> Path:
    """自动发现 i18n 目录。"""
    default = REPO_ROOT / "plugins" / "telegram" / "locales"
