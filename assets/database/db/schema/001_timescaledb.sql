-- TimescaleDB schema for current facts layout
-- 当前真相：
-- - schema: market
-- - 1m 基表: market.binance_futures_um_candles_1m
-- - 增量偏移: market.binance_ingest_offsets
-- - 更高周期通过 004 连续聚合生成
...
-- 1m candles ---------------------------------------------------------------
CREATE TABLE IF NOT EXISTS market.binance_futures_um_candles_1m (
...
CREATE TABLE IF NOT EXISTS market.binance_ingest_offsets (
    exchange            TEXT        NOT NULL,
    symbol              TEXT        NOT NULL,
