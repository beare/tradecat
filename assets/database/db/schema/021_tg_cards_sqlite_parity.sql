...
CREATE SCHEMA IF NOT EXISTS indicator_snapshots;

CREATE TABLE IF NOT EXISTS indicator_snapshots."MACD柱状扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "信号概述" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."KDJ随机指标扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "J值" double precision,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."ATR波幅扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "波动分类" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."G，C点扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."OBV能量潮扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."CVD信号排行榜.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."基础数据同步器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."主动买卖比扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "主动买量" double precision,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."期货情绪元数据.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "指标" double precision,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."K线形态扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "形态类型" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."趋势线榜单.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "趋势方向" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."全量支撑阻力扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."VPVR排行生成器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."超级精准趋势扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "趋势方向" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."布林带扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "带宽" double precision,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."VWAP离线信号扫描.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."成交量比率扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "量比" double precision,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."MFI资金流量扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "MFI值" double precision
);
CREATE TABLE IF NOT EXISTS indicator_snapshots."流动性扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."智能RSI扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "信号" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."趋势云反转扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "信号" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."大资金操盘扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "信号" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."量能斐波狙击扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "信号" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."零延迟趋势扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "信号" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."量能信号扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "信号" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."多空信号扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "信号" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."剥头皮信号扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "剥头皮信号" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."谐波信号扫描器.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "谐波值" double precision
);
CREATE TABLE IF NOT EXISTS indicator_snapshots."期货情绪聚合表.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "信号" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."SuperTrend.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."ADX.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."CCI.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."WilliamsR.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "WilliamsR" double precision
);
CREATE TABLE IF NOT EXISTS indicator_snapshots."Donchian.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "上轨" double precision,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."Keltner.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "上轨" double precision,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."Ichimoku.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."数据监控.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "已加载根数" integer,
...
CREATE TABLE IF NOT EXISTS indicator_snapshots."期货情绪缺口监控.py" (
"交易对" text,
  "周期" text,
  "数据时间" text,
  "信号" text,
...
-- 历史兼容脚本：旧派生 schema 名 `tg_cards` 的对齐入口。
-- 当前默认入口已切到 `021_indicator_snapshots_sqlite_parity.sql`。
