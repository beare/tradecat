...
-- - 但治理表 market.binance_ingest_watermark.last_time 约定为 epoch(ms)（与 REST since / ingest_gaps 同单位）
...
UPDATE market.binance_ingest_watermark
...
FROM market.binance_ingest_watermark
WHERE dataset = 'spot.trades'
