...
4. **杀死旧进程重启**
   ```bash
   pkill -9 -f "bot.js"
   cd /home/lenovo/.projects/tradecat/plugins/telegram
   node bot.js > logs/stdout.log 2>&1 &
   ```

## 备份位置
- 老版本备份：`/home/lenovo/.projects/tradecat/backups/gz/备份_20251211_101124.tar.gz`
- 恢复命令：
  ```bash
  cd /tmp && mkdir old_backup && cd old_backup
  tar -xzf /path/to/备份_20251211_101124.tar.gz plugins/telegram/src/
  ```
