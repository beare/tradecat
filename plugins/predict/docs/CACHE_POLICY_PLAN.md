# 信号缓存与清理策略：配置评估与执行方案
时间：2025-12-17  
范围：`plugins/telegram` 内的信号检测、市场数据与翻译缓存
...
## 6. 代码触点清单
- `plugins/telegram/signals/arbitrage/detector.js`
- `plugins/telegram/signals/orderbook/detector.js`
- `plugins/telegram/signals/price-spike/detector.js`
- `plugins/telegram/signals/new-market/detector.js`
- `plugins/telegram/utils/marketData.js`
- `plugins/telegram/translation/cache.js`
- `plugins/telegram/bot.js`
