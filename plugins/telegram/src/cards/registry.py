...
try:
    from path_setup import ensure_runtime_sys_path
except ImportError:  # pragma: no cover
    from src.path_setup import ensure_runtime_sys_path
...
class RankingRegistry:
    ...
    def load_cards(self) -> None:
        ...
        self._logger.info("🔧 补齐排行榜卡片依赖路径: %s", [str(repo_root), str(package_path.parent)])
