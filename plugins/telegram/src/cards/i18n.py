...
try:
    from path_setup import get_service_paths, load_shared_env
except ImportError:  # pragma: no cover
    from src.path_setup import get_service_paths, load_shared_env

load_shared_env()
LOCALE_STORE = get_service_paths().locale_store
