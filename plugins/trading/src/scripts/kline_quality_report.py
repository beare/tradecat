...
def _bootstrap_service_path() -> Path:
...
_bootstrap_service_path()

from src.config import ENV_FILE, get_market_candles_table, load_shared_env  # noqa: E402

load_shared_env()
_CANDLES_1M_TABLE = get_market_candles_table("1m")
