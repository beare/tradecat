...
2) 前台启动（便于观察输出）  
```bash
cd /home/lenovo/.projects/fate-engine/services/telegram
...
```bash
cd /home/lenovo/.projects/fate-engine/services/telegram
nohup python3 start.py bot > /home/lenovo/.projects/fate-engine/services/telegram/output/logs/nohup.out 2>&1 &
...
## 日志查看
```bash
tail -f /home/lenovo/.projects/fate-engine/services/telegram/output/logs/bot.log
```
